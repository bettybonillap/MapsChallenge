    ...
    public void execute(View view){
        switch (view.getId()){
            ...
            case R.id.style:
                ...
                break;
            case R.id.challenge:
                jsonMap("https://raw.githubusercontent.com/lutangar/cities.json/master/cities.json");
                break;
        }
    }
            ...
            public void onResponse(JSONArray response) {
                try {
                    for (int i = 0; i < 100; i++) {
                        ...
                        MarkerOptions markerOptions = new MarkerOptions();
                        markerOptions.position(latLng).title(data.getString("name")). icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE));
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i = 0;i<jsonArray.length();i++){
                        ...
                        JSONArray jsonComics =  comics.getJSONArray("items");

                        //marvelDude.comics= new String [jsonComics.length()];

                        //marvelDude.url=string;
                        //marvelDude.url2=string2;
                    }
                }
                catch(JSONException e){
                    e.printStackTrace();
